...
#'
#' @description
#' Retrieves China's Unemployment, total (% of total labor force)
...
#'
#' @export
get_china_unemployment <- function() {
  url <- "https://api.worldbank.org/v2/country/CHN/indicator/SL.UEM.TOTL.ZS?format=json&date=2010:2022&per_page=100"
  res <- httr::GET(url)
