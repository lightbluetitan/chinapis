...
This dataset, china_io_2020_42_df, is a data frame containing the
national input-output table of China for the year 2020. It includes 91
...
The dataset name has been kept as 'china_io_2020_42_df' to avoid
