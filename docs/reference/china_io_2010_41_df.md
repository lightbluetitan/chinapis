...
This dataset, china_io_2010_41_df, is a data frame that represents the
national input-output table of China for the year 2010. It covers 41
...
The dataset name has been kept as 'china_io_2010_41_df' to avoid
