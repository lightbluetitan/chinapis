...
This dataset, china_io_2017_42_df, is a data frame that represents the
national input-output table of China for the year 2017. It covers 42
sectors and provides inter-sectoral flows of goods and services. Data
values are measured in 10,000 Chinese Yuan (CNY).
...
The dataset name has been kept as 'china_io_2017_42_df' to avoid
