...
This dataset, china_io_2020_153_df, is a data frame that represents the
national input-output table of China for the year 2020. It covers 153
sectors and provides inter-sectoral flows of goods and services. Data
values are measured in 10,000 Chinese Yuan (CNY) and calculated at
producers' prices.
...
The dataset name has been kept as 'china_io_2020_153_df' to avoid
