...
This dataset, china_io_2017_149_df, is a data frame representing the
national input-output table of China for the year 2017. It covers 149
economic sectors and captures the inter-sectoral flows of goods and
services. The values are calculated at producers' prices and are
expressed in 10,000 Chinese Yuan (CNY).
...
The dataset name has been kept as 'china_io_2017_149_df' to avoid
